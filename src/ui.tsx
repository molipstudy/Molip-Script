...
const tips = {
  ...
  flashcard: ['← 다시 연습 · → 기억했어요 · ↑ 이전 · ↓ 다음 단축키를 사용할 수 있어요.', '카드를 누르거나, 카드에 포커스를 둔 상태에서 Space를 눌러 영어 문장을 확인하세요.', '‘다시 연습’을 선택하면 어려운 문장과 단어를 다음 학습에 활용할 수 있어요.'],
  dictation: ['← / → 키로 이전·다음 문장으로 이동할 수 있어요. 입력한 답은 그대로 유지돼요.', 'Enter를 누르면 다음 빈칸으로 이동하고, 마지막 빈칸에서는 채점해요.', '채점한 빈칸을 누르면 정답과 오답을 직접 바꿀 수 있어요. 키보드에서는 Space를 누르세요.'],
  graded: ['채점한 빈칸을 누르면 정답 ↔ 오답을 바꿀 수 있어요. 변경한 결과는 학습 기록에도 반영돼요.'],
